...
# # ---- Gemini: ask for ONE placement point ----
# DEFAULT_PLACE_VLM_QUERY_TEMPLATE = (
#     "You are given an image of a tabletop scene.\n"
#     "Select ONE point that lies on the TABLE SURFACE where it is safe to place an object.\n"
#     "The point must be on open tabletop (not on objects), not near edges, and not on the robot/gripper.\n\n"
#     "Return ONLY valid JSON (no markdown, no code fences, no extra text).\n"
#     'Output format (EXACTLY one JSON object): {"point": [y, x] | null, "label": "open_table_region"}\n'
...
def main() -> None:
    ...
    place_at(robot, z_above_surface_m=0.1)
