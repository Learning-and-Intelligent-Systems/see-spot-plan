"""Skill for erasing a whiteboard using Spot's arm and an iPhone depth stream."""
...
def wipe_online(
    ...
    """Detect whiteboard markings via VLM and erase them with wiping motions."""
    # stow the arm
    stow_arm(robot)
...
def main() -> None:
    """Parse arguments and execute the whiteboard erasing skill."""
